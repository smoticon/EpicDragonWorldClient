...
public class LoginScreenManager : MonoBehaviour
{
    ...
    private void Update()
    {
        if (autoSelect) // Auto navigate to first textbox.
        {
            autoSelect = false;
    ...
    // Selects an input field or button, activating the button if one is found.
    ...
    // Recursively finds the sorted index by positional order within m_orderedSelectables (positional order is determined from left-to-right followed by top-to-bottom).
